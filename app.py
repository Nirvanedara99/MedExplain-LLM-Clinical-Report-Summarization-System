...
<div class="hero-card">
    ...
    <div class="hero-title">🩺 Med<span>Explain</span></div>
    ...
    with left:
        st.markdown(
            ...
            <div class="dashboard-card" style="border-left: 3px solid var(--teal);">
                ...
                <div class="card-text">
                    MedExplain supports <strong style="color:var(--teal);">PDF, TXT, and DOCX</strong> formats.
...
def render_sidebar():
    ...
    st.sidebar.markdown(
        """<p style="font-size:11.5px;color:var(--text-muted);line-height:1.6;">
            MedExplain is an AI assistant for understanding reports.<br>
